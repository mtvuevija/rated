    ...
    var body: some View {
        ZStack {
            VStack(spacing: 30) {
                                ...
                                Auth.auth().signIn(with: credential) { (authResult, error) in
                                    ...
                                    CheckUser() { complete in
                                        if complete {
                                            ...
                                            self.msg = "This phone number is not linked to an existing account. Sign up to login."
                                            self.alert.toggle()
                                            self.loading.toggle()
                                            self.code = false
                                            self.enteredcode = ""
                ...
                }.padding(.bottom, 40)//.padding(10).padding(.vertical, 15).background(Color(.white).cornerRadius(30).shadow(color: Color(.black).opacity(0.1), radius: 15, x: 10, y: 10).shadow(color: .white, radius: 15, x: -10, y: -10)).padding(.bottom, 40)
        ...
        }.frame(width: self.screenwidth, height: self.screenheight).background(LinearGradient(gradient: Gradient(colors: [Color(.white), Color("lightgray")]), startPoint: .top, endPoint: .bottom).edgesIgnoringSafeArea(.all)).animation(.spring())
                ...
                Group {
                    ...
                    VStack(spacing: 20) {
                        ...
                        VStack(spacing: 35) {
                            ...
                            //.background(Color(.white).opacity(0.6).shadow(color: Color(.black).opacity(0.1), radius: 15, x: 10, y: 10).shadow(color: .white, radius: 15, x: -10, y: -10))
                            //.cornerRadius(25)
            ...
            ZStack {
                            ...
                            if self.report {
                                VStack(spacing: 20) {
                                        ...
                                        withAnimation {
                                            if self.confirm {
                                                if self.observer.keys >= 3 {
                                                    ...
                                                    //db.collection("users").document(uid!).updateData(["Rates": self.observer.userrates, "Comments": self.observer.comments, "Lock": self.observer.lock, "OverallRating": ototal/total, "AppearanceRating": atotal/total, "PersonalityRating": ptotal/total, "Keys": self.observer.keys])
                                    ...
                                    Button(action: {
                                        ...
                                        HStack {
                                            Text(self.confirm || self.confirm1 ? "Cancel" : "Report Comment")
                                                .font(Font.custom("ProximaNova-Regular", size: 22))
                                                .fontWeight(.semibold)
                                                .lineLimit(1)
                                                .animation(nil)
                ...
                ZStack {
                    ...
                    VStack {
                        ...
                        }.frame(width: screenwidth).padding(.vertical, 20).padding(.top, 10).background(Color(.white).cornerRadius(25).shadow(radius: 10))
                        Spacer()
                ...
                VStack {
                    HStack {
                        Button(action: {
                            ...
                            Image("back")//systemName: "chevron.left")
                                .resizable()
                    ...
                    VStack(spacing: 20) {
                        ...
                        Button(action: {
                            if self.confirm || self.confirm1 {
                                ...
                                db.collection("users").document(self.observer.users[self.observer.rated].id).updateData(["Report": reports])
                                self.report.toggle()
                                self.confirm1 = false
                                self.confirm = false
                                self.showcomment = false
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 10) {
                ...
                }.padding(.top, self.screenheight*0.055)
                HStack {
                    Button(action: {
                        self.profile = true
                    }) {
                ...
                if self.profile {
                    ...
                    }.frame(width: screenwidth - 40).background(Color(.white).cornerRadius(30)).padding(.bottom, 40)
                }
                //MARK: Settings
                else {
                    VStack(alignment: .leading) {
                        ...
                        Divider().frame(width: screenwidth - 40)
                    }.frame(width: screenwidth - 40).background(Color(.white)).cornerRadius(25)
                    HStack {
                        Button(action: {
...
struct Socials: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            }.frame(width: screenwidth - 40).background(Color(.white).cornerRadius(25)).padding(.bottom, 20)
...
struct Photos: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            }.padding(20).background(Color(.white).cornerRadius(35)).padding(.bottom, 20)
            //MARK: Edit Photos
            if loading {
                WhiteLoader()
            }
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 5) {
                            ...
                            if self.newbio[self.categories.firstIndex(of: cat)!] != "" || self.edit {
                                VStack(spacing: self.screenheight * 0.009) {
                                    ...
                                    if self.selected[self.categories.firstIndex(of: cat)!] && self.edit {
                                        ...
                                        }.frame(width: self.screenwidth - self.screenwidth*2*0.08)
                                    }
                ...
                }.cornerRadius(35).background(Color(.white).cornerRadius(35)).padding(.bottom, self.edit ? 0 : 15).padding(.top, self.edit ? 10 : 5)
                //MARK: Edit Bio
                if self.edit {
    ...
    var body: some View {
        ZStack {
            if self.observer.ratesinfo.count > self.index {
                ...
                }.blur(radius: self.unlocksocials || self.report ? 4 : 0).padding(20).background(Color(.white).cornerRadius(50).shadow(radius: 10))
                    ...
                    VStack {
                        ...
                        VStack(spacing: 20) {
                            if self.confirm {
                                VStack {
                                    Text("Are You Sure You Want To Report This User's Socials?")
                                        ...
                                        .multilineTextAlignment(.center)
                                        .padding(5)
                                    Text("(Only report if the user's socials do not match this person)")
                                        .font(Font.custom("ProximaNova-Regular", size: 16))
                                        .fontWeight(.semibold)
                                        .foregroundColor(Color(.gray))
                                        .animation(nil)
                                ...
                                VStack {
                                    Text("Are You Sure You Want To Report This User?")
                                        ...
                                        .multilineTextAlignment(.center)
                                        .padding(5)
                                    Text("(Only report if this user's profile is somehow inappropriate)")
                                        .font(Font.custom("ProximaNova-Regular", size: 16))
                                        .fontWeight(.semibold)
                                        .foregroundColor(Color(.gray))
                                        .animation(nil)
                            ...
                            Button(action: {
                               ...
                               Text(self.confirm || self.confirm1 ? "Confirm" : "Report Socials")
                                    .font(Font.custom("ProximaNova-Regular", size: 22))
                                    .fontWeight(.semibold)
                                    .animation(nil)
                                    .foregroundColor(.black)
                            ...
                            Button(action: {
                                ...
                                Text("Cancel")
                                    ...
                                    .frame(height: 50)
                                    .padding(.horizontal, 20)
                                    .background(Color("personality").cornerRadius(25).shadow(color: Color("lightgray").opacity(0.6), radius: 10))
                            }
                            
                        }.padding(20).background(Color(.white).cornerRadius(25).shadow(radius: 10)).padding(20).offset(y: self.report ? 0 : self.screenheight).padding(.bottom, 10)
                    }.frame(height: screenheight)
                }
            }
        }
    ...
    func relogin() {
        ...
        db.collection("users").getDocuments() { (querySnapshot, err) in
            if err != nil {
                ...
                while self.myprofile.Preferences.count == 0 {
                ...
                for document in querySnapshot!.documents {
                    if document.get("ID") as! String != self.id! && self.users.count < 100 {
                        ...
                        print((document.get("Preferences") as! [String]), "____" ,self.myprofile.Preferences)
                        if (document.get("Gender") as! String == self.myprofile.Preferences[0] && (document.get("Preferences") as! [String])[1] == self.myprofile.Gender) || (document.get("Preferences") as! [String])[1] == "Everyone" && ((document.get("Gender") as! String == self.myprofile.Preferences[0]) || self.myprofile.Preferences[0] == "Everyone") || (document.get("Preferences") as! [String])[1] == self.myprofile.Gender {
