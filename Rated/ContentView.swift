                        ...
                        ZStack {
                            ...
                            if self.ccode.isEmpty {
                                HStack {
                                    ...
                                    Spacer()
                                }.frame(width: 30, height: 50).animation(.easeInOut(duration: 0.1))
                            }
                ...
                VStack(spacing: 20) {
                    ...
                    Button(action: {
                        ...
                        Text("Next")
                            ...
                            .padding(.vertical, 10)
                            .padding(.horizontal, 30)
                    }.background(self.gender.count > 1 ? Color(.white).cornerRadius(20) : Color(.white).opacity(0.3).cornerRadius(20))
                ...
                VStack {
                    ...
                    HStack {
                        Image("instagram")
                            ...
                            .padding(10)
                        if self.instagram {
                            TextField("Your Instagram Handle", text: self.$instagramhandle)
                                .foregroundColor(Color(.white ))
                                .padding(10)
                    ...
                    HStack {
                        Image("twitter")
                            ...
                            .padding(10)
                        if self.twitter {
                            TextField("Your Twitter Handle", text: self.$twitterhandle)
                                .foregroundColor(Color(.white ))
                                .padding(10)
                                .frame(width: 175, height: 50)
                                .background(Color(.gray).opacity(0.2).cornerRadius(10))
                    ...
                    HStack {
                        Image("snapchat")
                            ...
                            .padding(10)
                        if self.snapchat {
                            TextField("Your Instagram Handle", text: self.$snapchathandle)
                                .foregroundColor(Color(.white ))
                                .padding(10)
                                .frame(width: 175, height: 50)
                                .background(Color(.gray).opacity(0.2).cornerRadius(10))
                    ...
                    ZStack {
                        VStack {
                            ...
                            ZStack {
                                ...
                                if self.adappear {
                                    RatingAd()
                                        .frame(width: screenwidth - 50, height: 70 - 10)
                                }
                            }.padding(.bottom, 20)
                        }
                        //MARK: Unlock
...
final class Rewarded: NSObject, GADRewardedAdDelegate{
    ...
    func rewardedAdDidDismiss(_ rewardedAd: GADRewardedAd) {
        self.rewardedAd = GADRewardedAd(adUnitID: "ca-app-pub-8107068593888585/2703558577") //"ca-app-pub-4206140009989967/9044631871")
        LoadRewarded()
    }
}
...
struct RatingAd : UIViewRepresentable {
    func makeUIView(context: UIViewRepresentableContext<RatingAd>) -> GADBannerView {
        ...
        //TODO: Redo
        ad.adUnitID = "ca-app-pub-8107068593888585/9123279654"//"ca-app-pub-4206140009989967/1095302745"
